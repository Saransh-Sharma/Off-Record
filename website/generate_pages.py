#!/usr/bin/env python3
"""Programmatic SEO page generator for OffRecord AI Journal blog."""
...
SITE_URL = "https://offrecord.example.com"
DATE = "2026-03-17"
...
<script>
  ...
  <title>{title} - OffRecord AI Journal Blog</title>
  ...
  <meta property="og:image" content="https://offrecord.example.com/og-image.png">
  ...
  {{
    ...
    "publisher": {{ "@type": "Organization", "name": "OffRecord AI Journal", "url": "https://offrecord.example.com" }},
