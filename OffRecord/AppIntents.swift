...
struct AddDiaryEntryIntent: AppIntent {
    ...
    static var description = IntentDescription("Add a new entry to your OffRecord AI Journal diary")
...
struct RecordVoiceEntryIntent: AppIntent {
    ...
    static var description = IntentDescription("Open OffRecord AI Journal to record a voice entry")
